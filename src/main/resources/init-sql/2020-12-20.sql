...
INSERT INTO `announcement` VALUES (2,'这是测试的公告内容','测试公告','2020-12-16 01:20:43','2020-12-16 01:20:43',1);
...
CREATE TABLE `appraise` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `last_edit_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  `type` int NOT NULL DEFAULT '0' COMMENT '评论类型：1-领导对督导的评价，2-领导对教师的评价',
  PRIMARY KEY (`id`)
...
INSERT INTO `elective` VALUES (1,4,1,2,'2020-12-14 23:56:21','2020-12-19 16:37:58');
...
-- Dump completed on 2020-12-20  4:00:06
